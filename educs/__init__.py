...
from educs.shapes import (moveX, moveY, movePos)
from educs.shapes import (circle, point, ellipse, triangle, rect, square, quad)

from educs.color import (background, clear)

from educs.transform import (translate, rotate, scale, applyMatrix, resetMatrix, shearX, shearY)
